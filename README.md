...
– [x] Логирование и мониторинг (Sentry)  
– [x] Трекинг экспериментов (MLflow/W&B)  
– [x] Перенос на PostgreSQL & Alembic  
– [x] Улучшенный UI Streamlit (кэш, графики, история)  
– [x] Docker-Compose prod и Kubernetes
